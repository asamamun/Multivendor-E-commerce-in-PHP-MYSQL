                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="brandLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            ...
                            <div class="collapse" id="productLayouts" aria-labelledby="headingOne" data-bs-parent="#productLayouts">
                                <nav class="sb-sidenav-menu-nested nav">
                    ...
                    <div class="sb-sidenav-footer">
                        ...
                        <?php echo $_SESSION['user_name'] ?? 'Alert!!!'; ?>
                    </div>
                </nav>
            </div>